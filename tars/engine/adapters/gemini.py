...
from tars.engine.adapters.base import BaseLLMAdapter, LLMResponse, ToolCallData
        ...
        **kwargs: Any,
        ...
        if hasattr(client, "aio") and hasattr(client.aio, "models"):
            ...
            if resp is not None and hasattr(resp, "function_calls") and resp.function_calls:
                for fc in resp.function_calls:
                    ...
                    parsed_tool_calls.append(ToolCallData(id=call_id, name=name, arguments=args))
        ...
        if resp is not None and hasattr(resp, "function_calls") and resp.function_calls:
            for fc in resp.function_calls:
                ...
                name = getattr(fc, "name", "")
                args = dict(getattr(fc, "args", {}) or {})
                sync_tool_calls.append(ToolCallData(id=call_id, name=name, arguments=args))
