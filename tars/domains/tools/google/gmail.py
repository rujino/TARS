...
logger = logging.getLogger("tars.domains.tools.google.gmail")
    ...
    def __init__(
        ...
        self._mock_messages: dict[str, dict[str, Any]] = {
            "msg_001": {
                ...
                "subject": "Weekly Schedule & Review",
                "snippet": "TARS, please prepare the upcoming weekly reflection summary for 주인님.",
                "body": "TARS, please prepare the upcoming weekly reflection summary and review notes for 주인님.",
