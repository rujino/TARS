...
from tars.domains.persona.schemas import TARSConfigUpdateRequest
...
class UserSettingsService:
    ...
    async def update_settings(self, user_id: str, payload: TARSConfigUpdateRequest) -> TARSSettings:
