...
class TARSSettings(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    google_mock_linked: Mapped[bool] = mapped_column(
        Boolean, default=False, nullable=False
    )
    google_client_id: Mapped[str | None] = mapped_column(
    ...
    def google_linked(self) -> bool:
        return bool(
            self.google_mock_linked
            or self.google_refresh_token
            or self.google_access_token
        )
